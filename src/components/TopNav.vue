      ...
      <ul class="navbar-nav">
        <li class="logo">
          <a href="/" class="nav-link">
            <span class="link-text logo-text">Golden Age<br>Tycoon</span>
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fad"
        ...
        <li class="nav-item">
          <a href="https://map.goldenagetycoon.com" target="_blank" class="nav-link">
        ...
        <li class="nav-item">
          <a href="https://discord.gg/KjkV7gheXB" target="_blank" rel="noopener noreferrer" class="nav-link">
